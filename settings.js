...
global.owner = process.env.OWNER_NUMBER  || '94760130075' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=KYU1RKJT#axyzOJgX5WlHFxen6btFnHN63XUFHyrd1ZwzV2ZVzJQ' ,
